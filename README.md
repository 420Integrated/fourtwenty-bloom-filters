[![npm version](https://badge.fury.io/js/fourtwenty-bloom-filters.svg)](https://badge.fury.io/js/fourtwenty-bloom-filters)
![downloads](https://img.shields.io/npm/dw/fourtwenty-bloom-filters)
...
```js
$ npm install fourtwenty-bloom-filters
```

### yarn:

```js
$ yarn add fourtwenty-bloom-filters
```
...
```js
var fourtwentyBloomFilters = require('fourtwenty-bloom-filters');
```

### JavaScript (ES5 or ES6)

```js
const fourtwentyBloomFilters = require('fourtwenty-bloom-filters');
```
...
import {
  isBloom,
  isUserFourtwentyAddressInBloom,
  isContractAddressInBloom,
  isTopic,
  isTopicInBloom,
  isInBloom
} from 'fourtwenty-bloom-filters';
```
...
If you're using a standard web application you can go [here](https://github.com/420integrated/fourtwenty-bloom-filters/tree/master/web-scripts) to copy any of the versioned script files and then dropping it into your web application, making sure you reference it within a script tag in the head of the website.

This will expose the library as a global variable named `fourtwentyBloomFilters`, you can then execute the methods through this variable:

```js
fourtwentyBloomFilters.isBloom(...)
fourtwentyBloomFilters.isUserFourtwentyAddressInBloom(...)
fourtwentyBloomFilters.isContractAddressInBloom(...)
fourtwentyBloomFilters.isTopic(...)
fourtwentyBloomFilters.isTopicInBloom(...)
fourtwentyBloomFilters.isInBloom(...)
```
...
## fourtwenty-bloom-filters benefits with an real life example
...
```ts
isUserFourtwentyAddressInBloom(bloom: string, ethereumAddress: string): boolean;
```
...
https://github.com/420integrated/fourtwenty-bloom-filters/issues
