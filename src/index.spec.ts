...
describe('isAddress', () => {
  it('should return true with a valid 420coin address', () => {
    expect(isAddress('0x494bfa3a4576ba6cfe835b0deb78834f0c3e3994')).toEqual(
      true,
    );
  });

  it('should return false with a invalid 420coin address', () => {
...
describe('isUserFourtwentyAddressInBloom', () => {
  ...
  it('should throw error if 420coin address is not valid', () => {
    expect(() => {
      isUserFourtwentyAddressInBloom(bloomFilter, '0x494b');
    }).toThrowError('Invalid 420coin address given: "0x494b"');
  });

  it('should throw error if 420coin address is a number', () => {
    expect(() => {
      // @ts-ignore
      isUserFourtwentyAddressInBloom(bloomFilter, 2);
    }).toThrowError('Invalid 420coin address given: "2"');
  });

  it('should throw error if 420coin address is a boolean', () => {
    expect(() => {
      // @ts-ignore
      isUserFourtwentyAddressInBloom(bloomFilter, false);
    }).toThrowError('Invalid 420coin address given: "false"');
  });

  it('should throw error if 420coin address is a object', () => {
    expect(() => {
      // @ts-ignore
      isUserFourtwentyAddressInBloom(bloomFilter, {});
    }).toThrowError('Invalid 420coin address given: "[object Object]"');
  });

  it('should return true if 420coin address is in bloom', () => {
    expect(
      isUserFourtwentyAddressInBloom(
        bloomFilter,
        '0x494bfa3a4576ba6cfe835b0deb78834f0c3e3994',
  ...
  it('should return false if fourtwenty address is not in bloom', () => {
    expect(
      isUserFourtwentyAddressInBloom(
        bloomFilter,
